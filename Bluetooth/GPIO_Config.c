...
const GPIO_ConfigType GPIO_ConfigParam [GPIO_NUMBER_OF_GROUPS] =
{
    ...
    
    {
        ...
        PIN_MASK_13, // sellect the pin number of the port (10)
    ...
    },
    {
                //set portA as an altirnative function
        PORT_GPIOD, // the choosen port
        PIN_MASK_1, // sellect the pin number of the port (10)
        MODE_OUTPUT, //set the mode to alternative function
        DEFAULT, //set the output type to the defalt value
        DEFAULT, //set the output speed to the defalt value
        DEFAULT  //set the pullup pulldown to the defalt value
    },
    {
                //set portA as an altirnative function
        PORT_GPIOD, // the choosen port
        PIN_MASK_2, // sellect the pin number of the port (10)
        MODE_OUTPUT, //set the mode to alternative function
        DEFAULT, //set the output type to the defalt value
        DEFAULT, //set the output speed to the defalt value
        DEFAULT  //set the pullup pulldown to the defalt value
    },
    {
                //set portA as an altirnative function
        PORT_GPIOD, // the choosen port
        PIN_MASK_3, // sellect the pin number of the port (10)
        MODE_OUTPUT, //set the mode to alternative function
        DEFAULT, //set the output type to the defalt value
        DEFAULT, //set the output speed to the defalt value
        DEFAULT  //set the pullup pulldown to the defalt value
    ...
    },
    {
        //set portA as an altirnative function
        PORT_GPIOD, // the choosen port
        PIN_MASK_8, // sellect the pin number of the port (9)
...

    {
                //set portA as an altirnative function
        PORT_GPIOD, // the choosen port
        PIN_MASK_9, // sellect the pin number of the port (10)
        MODE_ALTERNATIVE, //set the mode to alternative function
        DEFAULT, //set the output type to the defalt value 
        DEFAULT, //set the output speed to the defalt value 
        DEFAULT  //set the pullup pulldown to the defalt value 
